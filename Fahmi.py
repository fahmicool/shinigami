...
satpam.login(token="En53WaOPIDeuyJdCoeA7.16J7ZcRWn8lfVXGBIF2L9W.ZCFmgfHdcQZVzcY24hU1aIi+WJCOV7V/Hi5i10Fs98k=")
satpam.loginResult()

cl = LINETCR.LINE() ##Shunsui Kyōraku(LINE)
cl.login(token="En9ccjV8ECgexvhk5ZN7.XoKUfkjCfcdDXbki1v+NPW.0BMdazD+0fkzkf1H4UL4nRsdvPAuHEMY/8XIkzHPl9k=")
cl.loginResult()

ki = LINETCR.LINE() #Ichibē Hyōsube(LINE 1)
ki.login(token="EnYjJkN2e42ZscorFCM1.KnLhXtIqCLBr9JklqiYMKq.uiKPhk+wExhuxF9EegaMb5FFnIOPEjPkdL+b6YkjJSA=")
ki.loginResult()

kk = LINETCR.LINE() #Yoruichi Shihōin(LINE 2)
kk.login(token="En8YfcwlZLQTTNqCyPnf.naA6st3eWBJouHb2xAfnxW.uOhBqd7cKbuD3XxzSoKULzQ+EGb97uN5srUUPGUeH4g=")
kk.loginResult()

kc = LINETCR.LINE() #Kenpachi Kiganjō(LINE 3)
kc.login(token="EnYtKNX011II1CFS23a8.jpoWmIUdYS8Gb096cF+8oa.dAL1FYG8sNFPItXLFxKDr8NOsoZw9ZUVwsxuS/HJ72k=")
kc.loginResult()

ks = LINETCR.LINE() #Nanao Ise(LINE 4)
ks.login(token="EnLefp4QYfajvDsMuWye.8OCv7eAgFOIywa6B/lsWlG.OmwHvxmWHKYIELs2HjKVEgNsTtmf8Qf4s6KyddxJr54=")
ks.loginResult()

ka = LINETCR.LINE() #Momo Hinamori(LINE 5)
ka.login(token="En2fe2aqOANUOPH720re.Va9gqDzxaNh/GcslLt2fNG.Kcnacf2gPKkPnVS8pAdTMZUS80HskB6OI9qKBiHTv8o=")
ka.loginResult()

kb = LINETCR.LINE() #Rangiku Matsumoto(LINE 6)
kb.login(token="En7HcWtczqQX9bWsPms5.7JwPn+znizScM01CwWiwjq.9L9r61VZuaLfDQeM6V4SpH1u2rjAkEEebVOdGByE0h8=")
kb.loginResult()

ko = LINETCR.LINE() #Chikane Iba(LINE 7)
ko.login(token="EnleO26Ouza2zJIsrsr8.l99MILUQ7hqNn/1vRe8r2a.TQQLn5BlFWXHyxdZc4syu+5Z77ru/eP7k0jAzXK0DMc=")
ko.loginResult()

ke = LINETCR.LINE() #Hiyori Sarugaki(LINE 8)
ke.login(token="EneAjmFVDjvRGhuLtCm5.BnWNYew8e4iCKqf/Ha/E1q.yNWXfgR2SEL3ZVvRMJH3nWNIUq+R9ioljPQCBkvlRVQ=")
ke.loginResult()

ku = LINETCR.LINE() #Lisa Yadōmaru(LINE 9)
ku.login(token="Endsf7kakDHOHtGBbaT7.avnzqOTQntgFkB+/jodCLW.v6/QWGCYPRb/MXLdqULvSID70OYi9PPorVs3LrR8oIg=")
ku.loginResult()
...
k1.login(token="EnziZGL8wRjqZHTBdupe.qWAkC8c6vbUlpdYRR50BZG.AA1XbuO6FxqWhLJV79/ohGPkK0c5JYNnYQpLUPBRxK8=")
k1.loginResult()

print "SHINIGAMI LENGKAP"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage =""" ^[SHINIGAMI]^
OWNER •Muhammad Fahmi Ridhani•"""
...
||- Cancel all
==============
 Creator : http://line.me/ti/p/~fahmi_077
=============="""
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,mid1,"ud7a8fbcc2af037c2c5bf181b89fda5f7","uc4e92e14a25c1420ddc41288d55fe7a7"]
admin=["ud7a8fbcc2af037c2c5bf181b89fda5f7","ue027db6fbfa316a7ec28ed8d2cc2757d","uc4e92e14a25c1420ddc41288d55fe7a7"] 
...
☆ The Gantars Community ☆


Minat? Silahkan PM!
Idline: http://line.me/ti/p/~fahmi_077""",
    "lang":"JP",
    ...
    "dblack":False,
    "clock":False,
    "cName":"Shunsui Kyōraku ",
    "cName2":"Ichibē Hyōsube ",
    "cName3":"Yoruichi Shihōin ",
    "cName4":"Kenpachi Kiganjō ",
    "cName5":"Nanao Ise ",
    "cName6":"Momo Hinamori ",
    "cName7":"Rangiku Matsumoto ",
    "cName8":"Chikane Iba ",
    "cName9":"Hiyori Sarugaki ",
    "cName10":"Lisa Yadōmaru ",
    "cName11":"",
    "cName12":"™SHINIGAMI BOT™ ",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":True,
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                cl.findAndAddContactsByMid(midd="u43068a73c0ba541b8b3c3cabaf9d1bce")
                cl.inviteIntoGroup(msg.to,[midd])
            elif "Luffy invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("sinvite ","")
                ki.findAndAddContactsByMid(midd="uc4e92e14a25c1420ddc41288d55fe7a7")
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Zorro invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("tinvite ","")
                kk.findAndAddContactsByMid(midd="uc4e92e14a25c1420ddc41288d55fe7a7")
                kk.inviteIntoGroup(msg.to,[midd])
            elif "Zorro invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("finvite ","")
                kc.findAndAddContactsByMid(midd="uc4e92e14a25c1420ddc41288d55fe7a7")
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Tong","Luffy open qr"]:
                if msg.toType == 2:
                    X = satpam.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        satpam.sendText(msg.to,"")
                    else:
                        satpam.sendText(msg.to,"")
                else:
                    if wait["lang"] == "JP":
		...
		satpam.sendText(msg.to,"Auto Join Group by Ticket is %s" % str(wait["atjointicket"]))
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
				group=satpam.findGroupByTicket(ticket_id)
			satpam.acceptGroupInvitationByTicket(group.mid,ticket_id)
			satpam.sendText(msg.to,"Sukses join ke grup %s" % str(group.name))
              ...
              if msg.toType == 2:
                if msg.from_ in admin:
                  ...
                  if wait["lang"] == "JP":
                    satpam.sendText(msg.to,"Can not be used outside the group")
                  else:
                    satpam.sendText(msg.to,"Not for use less than group")
              ...
              if msg.from_ in admin:
                md = "⭐Status Keamanan⭐\n*============*\n"
                if wait["Protectgr"] == Fa: md+="[•]Protect QR [On]\n"
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cari dulu\nBaru Ketik Sider\nDASAR KONTOL ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","M","Join kuy"]:
              if msg.from_ in owner:
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = False
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Keluar","Kabur all","Kaboor all"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Pasukan","")
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                          if target not in admin and Bots:
                            try:
                                klist=[cl,ki,kk,kc,ks,ka,kb,ku,ke,ko,k1]
                                kicker=random.choice(klist)
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                ku.sendText(msg.to,"⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐")
                k1.sendText(msg.to,"⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐")
                cl.sendText(msg.to,"Pasukan Lengkap")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Creator by: MUhammad Fahmi Ridhani 😜")
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐SHINIGAMI BOT⭐⭐👈\n\n™SMULE VOICE FAMILY™")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^SHINIGAMI BOT^\nStatus Boss udah Kami Like\nOwner Kami :\nhttp://line.me/ti/p/~fahmi_077")
                    print "Like"
                except:
                    pass
            else:
